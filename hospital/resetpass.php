...
if(isset($_GET['id']) && isset($_GET['code']))
{
 ...
 $stmt = $user->runQuery("SELECT * FROM tbl_hospital WHERE userID=:uid AND tokenCode=:token");
 ...
 if($stmt->rowCount() == 1)
 {
  if(isset($_POST['btn-reset-pass']))
  {
   ...
   {
    $stmt = $user->runQuery("UPDATE tbl_hospital SET userPass=:upass WHERE userID=:uid");
