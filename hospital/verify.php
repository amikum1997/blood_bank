...
if(isset($_GET['id']) && isset($_GET['code']))
{
 ...
 $stmt = $user->runQuery("SELECT userID,userStatus FROM tbl_hospital WHERE userID=:uID AND tokenCode=:code LIMIT 1");
 ...
 if($stmt->rowCount() > 0)
 {
  ...
  {
   $stmt = $user->runQuery("UPDATE tbl_hospital SET userStatus=:status WHERE userID=:uID");
