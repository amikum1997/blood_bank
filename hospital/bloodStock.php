                    ...
                    <div class="col s12 m12 20">
						<div class="card">
							<div class="card-content">
								<p>TOTAL BLOOD AVILABLE IN INVENTORY</p>
								<div class="divider"></div>
								<br>
								...
								// fetch all records form blood_doner_record
									$sql = $user_home->runQuery("SELECT * FROM blood_doner_record WHERE hospitalName=:hname");
									$sql->execute(array(":hname"=>$row["hospitalName"]));
									if($sql->rowCount() > 0)
									{
									while($result = $sql->fetch(PDO::FETCH_ASSOC))
									{
										?>
										<tr>
                                    <td><?php echo $result['donerName']; ?></td>
                                    <td><?php echo $result['donerBloodGroup']; ?></td>
                                    <td><?php echo $result['donerPhNo']; ?></td>
